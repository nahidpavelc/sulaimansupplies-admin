        ...
        <div class="col-md-12">
            ...
            <div class="box box-danger box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo $this->lang->line('clint_update'); ?>  </h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <form action="<?php echo base_url("admin/our-clint/edit/".$edit_info->id);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <input name="name" placeholder="<?php echo $this->lang->line('clint_name'); ?> " class="form-control inner_shadow_red" required="" type="text"value="<?php echo $edit_info->client_name; ?>">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="box box-danger box-solid">
                                    ...
                                    <div class="box-body box-profile">
                                        <center>
                                            <img id="clint_picture_change" class="img-responsive" src="<?php echo base_url($edit_info->logo); ?>" alt="profile picture" style="max-width: 120px;"><small style="color: gray">width : 140px, Height : 40px</small>
                                            <br>
