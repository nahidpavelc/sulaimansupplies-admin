                ...
                <div class="col-md-7">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      ...
                      <input name="priority" class="form-control inner_shadow_red" placeholder="<?php echo $this->lang->line('priority'); ?>" type="number" value="<?php echo $slider_info->priority; ?>" min="1" max="1000">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      ...
                      <center>
                        ...
                        <img style="height: 200px" id="slider_photo_change" class="img-responsive" src="<?php echo base_url($slider_info->photo); ?>" alt="Slider Picture"><small style="color: gray">(Width:1350px; Height:390px;)</small><br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      ...
                      <center>
                        ...
                        <img id="slider_photo_change" class="img-responsive" src="//placehold.it/1350x390" alt="Slider Picture"><small style="color: gray">(Width:1350px; Height:390px;)</small>
              ...
              <table id="userListTable" class="table table-bordered table-striped table_th_maroon">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th style="width: 30%;"><?php echo $this->lang->line('subtitle'); ?></th>
