              ...
              <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <div class="col-sm-12">
                      <center>
                        <label class="" style="padding-top: 50px;"><?php echo $this->lang->line('services_photo'); ?></label>
                        <div class="">
                          <img id="service_photo_change" class="img-responsive"  alt="profile picture" src="<?php echo base_url('assets/upload.png') ?>" style="max-width: 120px;" ><small style="color: gray">width : 400px, Height : 400px</small>
                        </div>
                        <input class="" style="padding-top: 50px;" type="file" name="photo" onchange="readpicture(this);">
                        <br>
                      </center>
                    </div>
                  </div>
